# [TutsPlus: Membership site with WordPress](http://tutsplus.com/)

The files here are to aid a tutorial hosted on Tuts Plus. The tutorial is by written by Gavin Jaynes and uses the [Sage Starter Theme](http://roots.io/sage) as a base. You can view a [demo here](http://wp-ramble.com/tutsplus/membership).

This repo does not contain the [iTheme security plugin](https://wordpress.org/plugins/better-wp-security/) referred to in part one. You will need to install that separately. 

For more on Sage please see below.
